...
echo "This includes:"
echo "  • Custom Git configuration (guided setup for name, email, SSH keys)"
echo "  • GitHub CLI authentication"
echo ""
echo "Note: Python, Node.js, databases, and AI/ML tools can be installed"
echo "separately later using individual setup helpers."
echo ""
...
if [[ $REPLY =~ ^[Yy]$ ]]; then
    ...
    echo ""
    echo "You can run the full interactive setup later with:"
    echo "  cd $INSTALL_DIR"
    echo "  ./bootstrap.sh"
    echo ""
    echo "Or install additional tools individually:"
    echo ""
    ...
    echo ""
    echo "  Git & SSH setup (interactive):"
